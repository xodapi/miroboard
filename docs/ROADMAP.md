...
память настроек интерфейса на устройстве. Календарь ресурсов, SLA и
Парето-фронтир узкой роли уже в симуляции. Дальше по холсту — не равные
интервалы и не фреймы.
